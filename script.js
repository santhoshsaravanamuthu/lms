...
function addBook() {
  ...
  if (title && author && subject && publishDate) {
      const newBook = { title, author, subject, publishDate };
      books.push(newBook); // Update book list with new book added
      alert("successful");
      applyFilters();
  }
...
function applyFilters() {
  ...
  var dateFilter = document.getElementById("date-filter").value.toLowerCase();
